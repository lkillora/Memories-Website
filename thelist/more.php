...
<section>
   ...
   <div class="container">  
        ...
        {  
             echo '  
                  <tr>  
                       <td>  
                            <img src="data:image/jpeg;base64,'.base64_encode($row['pic'] ).'" class="img-thumnail" />  
                       </td>  
                  </tr>  
             ';  
        }  
   ...
   <div class="container">
   <div class="element_header">Insert Videos</div>  
        <br /> 
   <form method="post" action="" enctype='multipart/form-data'>
      <input type='file' name='file' /><br />
      <input type='submit' value='Upload' name='but_upload' class="btn btn-info">
    </form>
    <br />
    <br />
      <table class="table table-bordered">  
             <tr>  
                  <th><div class="element_header" style="text-align:center;">Already Uploaded Videos</div></th>  
             </tr>  
        <?php
        $moment_id =  
        $fetchVideos = mysqli_query($conn, "SELECT location FROM videos WHERE moment_id = '$moment_id' ORDER BY id DESC");
